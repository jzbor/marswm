...
pub fn keybindings<B: Backend<C>, C: Client>() -> Vec<Keybinding<B, C>> {
    vec![
        ...
        switch_workspace_binding!(XK_5, 4),
        switch_workspace_binding!(XK_6, 5),
        switch_workspace_binding!(XK_7, 6),
        switch_workspace_binding!(XK_8, 7),
        move_workspace_binding!(XK_1, 0),
        move_workspace_binding!(XK_2, 1),
        move_workspace_binding!(XK_3, 2),
        move_workspace_binding!(XK_4, 3),
        move_workspace_binding!(XK_5, 4),
        move_workspace_binding!(XK_6, 5),
        move_workspace_binding!(XK_7, 6),
        move_workspace_binding!(XK_8, 7),
